...
class CampaignDataTrackingData implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'trackingSettings' => '\Sedo\SedoTMP\OpenApi\Platform\Model\CampaignDataTrackingDataTrackingSettings',
        'trackingMethod' => 'string',
        'postbacks' => '\Sedo\SedoTMP\OpenApi\Platform\Model\Postback[]',
    ];
    ...
    public const TRACKING_METHOD_PIXEL = 'PIXEL';
     ...
     * Sets trackingMethod.
     *
     * @param string $trackingMethod Tracking method: Currently pixel tracking is only supported for meta
     *
     * @return self
     */
