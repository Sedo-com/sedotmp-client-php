...
/**
 * ContentCampaignResponseCampaign Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class ContentCampaignResponseCampaign implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ContentCampaignResponse_campaign';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'trackingData' => '\Sedo\SedoTMP\OpenApi\Platform\Model\CampaignDataTrackingData',
        'id' => 'string',
    ];
    ...
    public function setName($name)
    {
        ...
        if (mb_strlen($name) < 1) {
            throw new \InvalidArgumentException('invalid length for $name when calling ContentCampaignResponseCampaign., must be bigger than or equal to 1.');
        }
     ...
     * Gets trackingData.
     *
     * @return CampaignDataTrackingData|null
     */
     ...
     * Sets trackingData.
     *
     * @param CampaignDataTrackingData|null $trackingData trackingData
     *
     * @return self
     */
