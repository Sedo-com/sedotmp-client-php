...
/**
 * FilterDeviceType Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class FilterDeviceType implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'FilterDeviceType';
    ...
    public const VALUES_MOBILE = 'MOBILE';
    public const VALUES_DESKTOP = 'DESKTOP';
    public const VALUES_OTHER = 'OTHER';
    ...
    public function setValues($values)
    {
        ...
        if (array_diff($values, $allowedValues)) {
            throw new \InvalidArgumentException(sprintf("Invalid value for 'values', must be one of '%s'", implode("', '", $allowedValues)));
        }
