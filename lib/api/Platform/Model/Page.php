...
class Page implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function setPage($page)
    {
        ...
        if ($page < 0) {
            throw new \InvalidArgumentException('invalid value for $page when calling Page., must be bigger than or equal to 0.');
        }
    ...
    public function setSize($size)
    {
        ...
        if ($size > 10) {
            throw new \InvalidArgumentException('invalid value for $size when calling Page., must be smaller than or equal to 10.');
        }
        if ($size < 1) {
            throw new \InvalidArgumentException('invalid value for $size when calling Page., must be bigger than or equal to 1.');
        }
