...
class Pageable implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets sort.
     *
     * @param string|null $sort in order to sort by multiple fields, provide a `sort=field,direction` query parameter for each field
     *
     * @return self
     */
    ...
    public function setSize($size)
    {
        ...
        if ($size > 10) {
            throw new \InvalidArgumentException('invalid value for $size when calling Pageable., must be smaller than or equal to 10.');
        }
        if ($size < 1) {
