...
use Sedo\SedoTMP\OpenApi\FormDataProcessor;
...
class MediaResourceApi
{
     ...
     *
     * @return \Sedo\SedoTMP\OpenApi\Content\Model\MediaResourceResponse[]|\Sedo\SedoTMP\OpenApi\Content\Model\Problem|\Sedo\SedoTMP\OpenApi\Content\Model\Problem
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
     ...
     * @param string                                            $contentType The value for the Content-Type header. Check self::contentTypes['mediaGet'] to see the possible values for this operation
     *
     * @return array of \Sedo\SedoTMP\OpenApi\Content\Model\MediaResourceResponse[]|\Sedo\SedoTMP\OpenApi\Content\Model\Problem|\Sedo\SedoTMP\OpenApi\Content\Model\Problem, HTTP status code, HTTP response headers (array of strings)
     *
     * @throws ApiException              on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     */
    public function mediaGetWithHttpInfo($page = null, string $contentType = self::contentTypes['mediaGet'][0])
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Sedo\SedoTMP\OpenApi\Content\Model\MediaResourceResponse[]',
                        $request,
                        $response,
                    );
                case 400:
    ...
    {
        $returnType = '\Sedo\SedoTMP\OpenApi\Content\Model\MediaResourceResponse[]';
        $request = $this->mediaGetRequest($page, $contentType);
