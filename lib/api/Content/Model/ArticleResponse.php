...
class ArticleResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function setContentPhrases($contentPhrases)
    {
        ...
        if (count($contentPhrases) > 5) {
            throw new \InvalidArgumentException('invalid value for $contentPhrases when calling ArticleResponse., number of items must be less than or equal to 5.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if (mb_strlen($country) > 2) {
            throw new \InvalidArgumentException('invalid length for $country when calling ArticleResponse., must be smaller than or equal to 2.');
        }
     ...
     * Sets topics.
     *
     * @param string[]|null $topics List of topics used to generate the article
     *
     * @return self
     */
