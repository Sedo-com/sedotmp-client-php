...
/**
 * UpdateArticle Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class UpdateArticle implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpdateArticle';
    ...
    public function setCountry($country)
    {
        ...
        if (mb_strlen($country) > 2) {
            throw new \InvalidArgumentException('invalid length for $country when calling UpdateArticle., must be smaller than or equal to 2.');
        }
