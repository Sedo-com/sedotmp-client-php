...
class GenerateArticle implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function setTopics($topics)
    {
        ...
        if (count($topics) > 3) {
            throw new \InvalidArgumentException('invalid value for $topics when calling GenerateArticle., number of items must be less than or equal to 3.');
        }
        if (count($topics) < 1) {
            throw new \InvalidArgumentException('invalid length for $topics when calling GenerateArticle., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets contentPhrases.
     *
     * @param string[]|null $contentPhrases List of phrases to enhance the generated content
     *
     * @return self
     */
    public function setContentPhrases($contentPhrases)
    {
        ...
        if (count($contentPhrases) > 5) {
            throw new \InvalidArgumentException('invalid value for $contentPhrases when calling GenerateArticle., number of items must be less than or equal to 5.');
        }
