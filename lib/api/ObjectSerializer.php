...
use Sedo\SedoTMP\OpenApi\Content\Model\ModelInterface as ContentModelInterface;
use Sedo\SedoTMP\OpenApi\Platform\Model\ModelInterface as PlatformModelInterface;
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\Sedo\SedoTMP\OpenApi\Model\\'.$data->{$discriminator};
