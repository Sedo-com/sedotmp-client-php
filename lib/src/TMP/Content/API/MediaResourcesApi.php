...
class MediaResourcesApi
{
     ...
     * @return void
     */
    public function mediaIdDelete($id)
    {
        $this->mediaIdDeleteWithHttpInfo($id);
    }
     ...
     */
    public function mediaIdDeleteWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->mediaIdDeleteRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function mediaIdDeleteAsync($id)
    {
        return $this->mediaIdDeleteAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function mediaIdDeleteAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->mediaIdDeleteRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function mediaIdDeleteRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
