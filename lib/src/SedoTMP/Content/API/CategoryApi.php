...
class CategoryApi
{
     ...
     * @return \Sedo\SedoTMP\Content\Model\CategoryResponse[]
     */
    public function categoriesGet($page = null, $term = null)
    {
        list($response) = $this->categoriesGetWithHttpInfo($page, $term);
        return $response;
    }
     ...
     * @throws \Sedo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Sedo\SedoTMP\Content\Model\CategoryResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function categoriesGetWithHttpInfo($page = null, $term = null)
    {
        $returnType = '\Sedo\SedoTMP\Content\Model\CategoryResponse[]';
        $request = $this->categoriesGetRequest($page, $term);
     ...
     */
    public function categoriesGetAsync($page = null, $term = null)
    {
        return $this->categoriesGetAsyncWithHttpInfo($page, $term)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function categoriesGetAsyncWithHttpInfo($page = null, $term = null)
    {
        $returnType = '\Sedo\SedoTMP\Content\Model\CategoryResponse[]';
        $request = $this->categoriesGetRequest($page, $term);
     ...
     */
    protected function categoriesGetRequest($page = null, $term = null)
    {
     ...
     *
     * @param  \Sedo\SedoTMP\Content\Model\CreateCategory $body body (required)
     *
     * @throws \Sedo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Sedo\SedoTMP\Content\Model\CategoryResponse
     ...
     * Create a new content category
     *
     * @param  \Sedo\SedoTMP\Content\Model\CreateCategory $body (required)
     *
     * @throws \Sedo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Sedo\SedoTMP\Content\Model\CategoryResponse, HTTP status code, HTTP response headers (array of strings)
