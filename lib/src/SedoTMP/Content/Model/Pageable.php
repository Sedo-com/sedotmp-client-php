...
class Pageable implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets page.
     *
     * @param int|null $page 0-indexed page number
     *
     * @return self
     */
     ...
     * Sets sort.
     *
     * @param string|null $sort Since this will be used in query string, it is possible to send multiple `sort=property,direction` parameters
     *
     * @return self
     */
